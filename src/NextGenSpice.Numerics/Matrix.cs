...
namespace NextGenSpice.Numerics
{
    ...
    public class Matrix<T> : ICloneable
    {
        ...
        /// <summary>Number of rows or columns in the matrix.</summary>
        public int Size { get; }

        /// <summary>Inner one-dimensional representation of the matrix, element [i,j] is on index i * size + j.</summary>
