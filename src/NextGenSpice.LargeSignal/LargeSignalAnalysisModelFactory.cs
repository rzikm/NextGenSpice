...
namespace NextGenSpice.LargeSignal
{
	...
	public class LargeSignalAnalysisModelFactory : AnalysisModelFactory<LargeSignalCircuitModel>
	{
		public LargeSignalAnalysisModelFactory()
		{
			...
			SetModel<Ccvs, LargeSignalCcvs>((e, ctx) =>
				new LargeSignalCcvs(e, (LargeSignalVoltageSource) ctx.GetModel(e.Ampermeter)));
			SetModel<Cccs, LargeSignalCccs>((e, ctx) =>
				new LargeSignalCccs(e, (LargeSignalVoltageSource) ctx.GetModel(e.Ampermeter)));
