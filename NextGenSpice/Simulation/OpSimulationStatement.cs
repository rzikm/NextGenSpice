...
namespace NextGenSpice.Simulation
{
    ...
    public class OpSimulationStatement : SpiceSimulationStatement, ISimulationStatement
    {
        private readonly IDictionary<int, string> nodeNames;
        private readonly OpStatementParam param;

        public OpSimulationStatement(OpStatementParam param, IDictionary<int, string> nodeNames)
        {
            this.param = param;
