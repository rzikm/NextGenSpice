...
{
    /// <summary>
    /// Defines methods for registering analysis models for individual circuit devices and building whole analysis models from circuit representation.
    /// </summary>
    ...
    public interface IAnalysisModelFactory<TAnalysisModel>
    {
        ...
        /// <typeparam name="TModel">Analysis-specific class for the device</typeparam>
        /// <param name="factoryFunc">The factory function</param>
        void SetModel<TRepresentation, TModel>(Func<TRepresentation, IModelInstantiationContext<TAnalysisModel>, TModel> factoryFunc)
            where TRepresentation : ICircuitDefinitionElement
            where TModel : IAnalysisDeviceModel<TAnalysisModel>;
