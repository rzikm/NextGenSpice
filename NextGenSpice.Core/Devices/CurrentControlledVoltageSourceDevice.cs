...
namespace NextGenSpice.Core.Devices
{
    ...
    public class CurrentControlledVoltageSourceDevice : TwoTerminalCircuitDevice
    {
        public CurrentControlledVoltageSourceDevice(VoltageSourceDevice ampermeter, double gain, string tag = null) :
            base(tag)
        {
